...
var _chunkZJMYPFP6js = require('./chunk-ZJMYPFP6.js');


var _chunkSEFDZLQVjs = require('./chunk-SEFDZLQV.js');


var _chunkQTSFUKLSjs = require('./chunk-QTSFUKLS.js');
  ...
  return {
    ...
    getSetupAst() {
      if (!descriptor.scriptSetup)
        return;
      return _chunkZJMYPFP6js.babelParse.call(void 0, descriptor.scriptSetup.content, lang);
    },
    getScriptAst() {
      if (!descriptor.script)
        return;
      return _chunkZJMYPFP6js.babelParse.call(void 0, descriptor.script.content, lang);
    }
  };
}
function getFileCodeAndLang(code, id) {
  var _a;
  if (!_chunkQTSFUKLSjs.REGEX_VUE_SFC.test(id))
    return { code, lang: _chunkSEFDZLQVjs.getLang.call(void 0, id) };
