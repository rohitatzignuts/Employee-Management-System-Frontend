...
function P2(t3, e3) {
  if (e3) {
    if (!C(e3, R2))
      Object.defineProperty(e3, R2, { value: t3 });
    else if (t3 !== e3[R2])
      throw new Error(`Trying to cast object to subject type ${t3} but previously it was casted to ${e3[R2]}`);
  }
  return e3;
}
var S2 = (t3) => {
...
var Z = class {
  ...
  possibleRulesFor(t3, e3 = this.g) {
    ...
    if (e3 !== this.g)
      r2 = U2(r2, this.possibleRulesFor(t3, this.g));
    s3.rules = r2;
    s3.merged = true;
    return r2;
  }
  ...
  actionsFor(t3) {
    ...
    if (i4)
      Array.from(i4.keys()).forEach((t4) => e3.add(t4));
    const s3 = t3 !== this.g ? this.j.get(this.g) : void 0;
    if (s3)
      Array.from(s3.keys()).forEach((t4) => e3.add(t4));
